        ...
        <div className='group/card relative grid  grid-cols-[max-content,minmax(0,1fr)] gap-3 border-b'>
          ...
          >
            <Check
              strokeWidth={4}
              className={cn(
                '!h-3 !w-3 text-muted-foreground group-hover/button:opacity-100 transition-opacity',
            ...
            <CardFooter className='p-0 flex gap-4'>
              ...
              {location.pathname !== '/app/inbox' &&
                location.pathname !== `/app/projects/${project?.$id}` && (
                  <div className='grid grid-cols-[minmax(0,180px),max-content] items-center gap-2 text-sm text-muted-foreground ms-auto'>
          ...
          <div
            className='absolute top-1.5 right-0 bg-background ps-1 
           shadow-[-10px_0_5px_hsl(var(--background))] flex items-center gap-1
           opacity-0 group-hover/card:opacity-100 focus-within:opacity-100 max-md:opacity-100'
          >
            {!task.completed && (
