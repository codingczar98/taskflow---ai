  ...
  return (
    <>
      <div className='relative isolate min-h-[100dvh] flex flex-col overflow-hidden'>
        ...
        {/* Background shapes */}
        <div
          className='bg-primary/20 absolute top-20 left-0 w-80
           h-10 rotate-45 origin-top-left blur-3xl'
        ></div>
        <div
          className='bg-primary/20 absolute top-20 right-0 w-80
           h-10 -rotate-45 origin-top-right blur-3xl'
        ></div>

        {/* Loader */}
        {isLoading && (
          <div
            className='fixed top-0 left-0 z-50 w-full h-[100dvh] bg-background
